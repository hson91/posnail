    ...
    <div class="col-7">
        <div class="store">
            ...
            <div class="action">
                ...
                <?php echo CHtml::link('<i>&#xf00d;</i>Delete', array('delete')); ?>
            </div>
            <div class="col-12">
                <label>Manager: </label>
                <span><?php echo ($model->userManager() != null) ?Chtml::link($model->userManager()->s_fullname,array("user/detail","id" => $model->userManager()->id),array("class"=>"link")):"N/A"?></span>
            </div>
            <div class="col-12">
                <label>Name: </label>
