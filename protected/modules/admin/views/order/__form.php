...
?>
    ...
    <div class="controls">
        <div class="label">
            <?php echo $form->labelEx($model,'i_shopping',array('class'=>'lbl-form')); ?>
        </div>
        <div class="input">
            <input type="hidden" name="User[i_shopping]" value="1" />
            <input type="text" disabled="disable" value="Store" style="cursor: not-allowed;" readonly="readonly" class="txt-form" />
