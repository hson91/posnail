<div class="action">
    <?php echo CHtml::link('<i>&#xf234;</i>Add Type Service', array('add')); ?>
</div>
<?php 
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'s_image_server',
            'value' => '($data->s_image_server != "")?CHtml::image(Yii::app()->baseUrl."/data/service_type/120x120_".$data->s_image_server,"",array("style"=>"width:35px")):"<div style=\"width:35px; height:35px; background:#".sprintf("%06x",rand(0,987654))."; margin:0 auto \"></div>"',
            'filter' => false,
            'type'=>'raw',
        ...
        array(
            'name'=>'s_name',
            'value' => 'Chtml::link($data->s_name,array("serviceType/detail","alias" => $data->pk_s_id),array("class"=>"link detailType"))',
            'type'=>'raw',
        ...
        array(
            ...
            'buttons' => array(
                'edit'=>array(
                    'label'=>'<i>&#xf040;</i> EDIT',
                    'imageUrl' => false,
                    'url' => 'array("serviceType/edit","id" => $data->id)',
